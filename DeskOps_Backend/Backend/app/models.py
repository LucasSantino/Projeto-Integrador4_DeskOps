...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    foto_user = models.ImageField(upload_to='perfil/', null=True, blank=True)  # 👈 upload real
...
class Chamado(models.Model):
    ...
    environment = models.ForeignKey(Environment, related_name='chamado_environment_FK', on_delete=models.SET_NULL, null=True, blank=True)  # 👈 novo campo
