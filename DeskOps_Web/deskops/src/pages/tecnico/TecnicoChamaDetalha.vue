...
.content-area {
  ...
  max-width: 1200px;
  height: auto;
  min-height: auto; /* Remove altura mínima fixa para permitir scroll natural */
  overflow: visible; /* Permite que o conteúdo flua naturalmente */
  padding: 0 40px;
  padding-bottom: 40px; /* Adiciona espaço no final para melhor visualização */
}
...
@media (max-width: 768px) {
  ...
  .main-content {
    ...
    overflow-y: auto; /* Mantém scroll no mobile */
  }
