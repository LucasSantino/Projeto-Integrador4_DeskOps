...
const __VLS_export = defineComponent({
    ...
    setup() {
        ...
        const obterNomeAtivo = (ativoId) => {
            const ativo = ativos.value.find((a) => a.id === ativoId);
        ...
        const confirmarCriacao = () => {
            ...
            showCustomPopup('confirm', 'Confirmar Criação', 'Tem certeza que deseja criar este chamado? Esta ação não pode ser desfeita.', 'Criar Chamado', submitChamado);
        };
        ...
        const submitChamado = async () => {
            try {
                ...
                showCustomPopup('success', 'Sucesso!', 'Chamado criado com sucesso! Você será redirecionado para a lista de chamados.', 'OK', () => {
        ...
        const onFileChange = (event) => {
            ...
            if (target.files && target.files[0]) {
                ...
                if (fileText)
                    fileText.textContent = target.files[0].name;
            }
            else {
                imagem.value = null;
                ...
                const fileText = document.querySelector('.file-text');
                if (fileText)
                    fileText.textContent = 'Nenhum arquivo escolhido';
            }
        };
...
/** @type {__VLS_StyleScopedClasses['novo-chamado-page']} */ ;
/** @type {__VLS_StyleScopedClasses['main-content']} */ ;
/** @type {__VLS_StyleScopedClasses['content-area']} */ ;
...
__VLS_asFunctionalElement(__VLS_elements.select, __VLS_elements.select)({
    value: (__VLS_ctx.ativoSelecionado),
    ...{ class: "form-select" },
});
// @ts-ignore
[ativoSelecionado,];
...
for (const [a] of __VLS_getVForSourceType((__VLS_ctx.ativos))) {
    // @ts-ignore
    [ativos,];
    __VLS_asFunctionalElement(__VLS_elements.option, __VLS_elements.option)({
        key: (a.id),
...
__VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
    ...{ class: "form-section file-section" },
});
__VLS_asFunctionalElement(__VLS_elements.h3, __VLS_elements.h3)({
    ...{ class: "section-title" },
});
...
(__VLS_ctx.obterNomeAtivo(__VLS_ctx.ativoSelecionado) || 'Nenhum selecionado');
// @ts-ignore
[ativoSelecionado, obterNomeAtivo,];
__VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
    ...{ class: "summary-section" },
});
__VLS_asFunctionalElement(__VLS_elements.p, __VLS_elements.p)({
...
__VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
    ...{ onClick: (__VLS_ctx.confirmarCriacao) },
    ...{ class: "create-btn" },
    disabled: (__VLS_ctx.isLoading),
});
// @ts-ignore
[confirmarCriacao, isLoading,];
(__VLS_ctx.isLoading ? 'Criando...' : 'Criar Chamado');
// @ts-ignore
[isLoading,];
...
/** @type {__VLS_StyleScopedClasses['form-select']} */ ;
/** @type {__VLS_StyleScopedClasses['form-section']} */ ;
/** @type {__VLS_StyleScopedClasses['file-section']} */ ;
/** @type {__VLS_StyleScopedClasses['section-title']} */ ;
...
export default {};
//# sourceMappingURL=novoChamado.vue.js.map